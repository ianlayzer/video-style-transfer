...
Original file is located at
    https://colab.research.google.com/drive/1x4Yf4Z3bWIOAqqpTGEtOZdaLx-RKKXhy
"""
...
for e in range(num_epochs):
  ...
  output_stylized_img.assign(output_stylized_img) # need to clip, check if from 0 to 1 or 0 to 255
